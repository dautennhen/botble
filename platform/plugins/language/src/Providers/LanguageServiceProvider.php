...
//                ->usePath()->add('custom', 'js/custom.min.js', ['jquery'], [], '5.10')
                ...
                ->usePath(false)->add('language-global-js', 'vendor/core/plugins/language/js/language-global.js', ['app.js'], ['defer' => 'defer']);
            Theme::asset()
                ->container('header')
...
//                ->usePath()->add('ionicons', 'plugins/ionicons/css/ionicons.min.css')
                ->usePath(false)->add('language-global-style','vendor/core/plugins/language/css/language.css');
        });
